    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-blue-50 to-indigo-100">
      ...
      <div className="max-w-2xl mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6 pb-24">
        ...
        <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm overflow-hidden">
          <div className="bg-gradient-to-r from-primary to-indigo-600 p-4 sm:p-6">
          ...
          <div className="p-4 sm:p-6 space-y-3">
              ...
              <div key={item.id} className="flex items-start sm:items-center justify-between py-3 border-b border-gray-100 last:border-0 gap-3">
                ...
                <div className="flex flex-col sm:flex-row items-end sm:items-center gap-2 sm:gap-3">
                  <div className="flex items-center gap-1.5 bg-primary/5 rounded-lg p-1">
                    ...
                    <span className="font-bold text-primary/70 text-sm sm:text-base min-w-[24px] text-center">
                      {item.quantity}
                    </span>
                    <button
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-400 rounded-xl p-4 mt-4 flex justify-between items-center shadow-sm">
              <span className="font-bold text-lg sm:text-xl text-primary/70">Total</span>
              <span className="font-bold text-xl sm:text-2xl text-primary/70">R$ {getTotalPrice().toFixed(2)}</span>
            </div>
          </div>
        </Card>
              ...
              <Card className="shadow-xl border-0 bg-gradient-to-br from-green-50 to-emerald-50 sm:shadow-lg">
                <div className="p-4 sm:p-6 space-y-4">
                  ...
                  <Button
                    ...
                    size="lg"
                    className="w-full bg-gradient-to-r from-primary via-primary/90 to-accent/90 hover:from-primary/90 hover:via-purple-800 hover:to-accent/80 text-white font-bold py-6 sm:py-7 rounded-xl shadow-lg hover:shadow-xl transition-all active:scale-98 text-base sm:text-lg"
                    disabled={loading}
                  >
                    {loading ? (
