...
const Payment = () => {
  ...
  const getStatusBadge = () => {
    switch (paymentStatus) {
      ...
      default:
        return <Badge className="bg-primary text-white border-2 border-purple-400 shadow-lg animate-pulse-badge" aria-label="Status: Aguardando pagamento"><Clock className="w-4 h-4 mr-1" aria-hidden="true" />Aguardando</Badge>;
    }
  };
