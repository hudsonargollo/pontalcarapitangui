            ...
            >
              <Card className="p-6 sm:p-8 shadow-xl border-2 border-primary/10">
                <div className="text-center mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-primary/50 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-primary to-indigo-600 hover:from-primary/90 hover:to-accent/90 text-white font-bold py-6 text-lg shadow-lg hover:shadow-xl transition-all"
                  >
                    Continuar →
                  </Button>
                </div>
            ...
            >
              <Card className="p-6 sm:p-8 shadow-xl border-2 border-primary/10">
                ...
                <div className="space-y-4">
                  ...
                  {/* Total */}
                  <div className="bg-gradient-to-r from-primary to-indigo-600 rounded-xl p-5 flex justify-between items-center shadow-lg">
                  ...
                  <div className="space-y-3 pt-4">
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="w-full py-6 text-lg font-semibold border-2 hover:bg-primary/5 hover:border-primary/30 transition-colors"
                    >
                      ✏️ Editar Pedido
                    </Button>
                  </div>
