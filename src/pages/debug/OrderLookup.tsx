      ...
      <div className="max-w-2xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Button
            ...
            className="w-full py-4 text-base font-bold border-2 border-primary/30 text-primary/90 hover:bg-primary/5 hover:border-primary hover:text-primary/80 transition-all duration-300 transform hover:scale-105 rounded-xl shadow-lg"
          >
            📋 Ver Cardápio
          </Button>
        </div>
