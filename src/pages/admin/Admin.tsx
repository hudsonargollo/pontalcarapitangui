              ...
              >
                <CardContent className="p-4 sm:p-6 text-center relative h-full flex flex-col justify-center items-center">
                  ...
                  <div className="relative mb-3 sm:mb-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto bg-gradient-to-br from-primary via-primary/90 to-blue-600 rounded-xl flex items-center justify-center shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300">
                  ...
                  <div className="relative">
                    <h3 className="font-bold text-sm sm:text-lg text-gray-900 mb-1 sm:mb-2 group-hover:text-primary/90 transition-colors">
                      {item.title}
                    </h3>
