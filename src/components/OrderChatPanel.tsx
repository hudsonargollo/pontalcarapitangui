...
export function OrderChatPanel({ orderId, customerPhone }: OrderChatPanelProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-primary/5 to-white rounded-xl border-2 border-primary/10">
      {/* Header */}
      <div className="bg-gradient-to-r from-primary to-indigo-600 px-4 py-3 rounded-t-xl">
      ...
      {/* Input Area */}
      <div className="border-t-2 border-primary/10 p-4 bg-white rounded-b-xl">
        <div className="flex gap-2">
          <Input
            ...
            disabled={sending}
            className="flex-1 border-2 border-primary/20 focus:border-purple-400 rounded-full px-4"
          />
          <Button
            onClick={handleSendMessage}
            disabled={!messageInput.trim() || sending}
            className="bg-gradient-to-r from-primary to-indigo-600 hover:from-primary/90 hover:to-accent/90 rounded-full px-6"
          >
            {sending ? (
