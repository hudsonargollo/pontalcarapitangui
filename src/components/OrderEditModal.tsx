      ...
      <DialogContent className="max-w-2xl w-[calc(100vw-1rem)] sm:w-full max-h-[96vh] sm:max-h-[90vh] flex flex-col p-0 gap-0 rounded-2xl m-2 sm:m-0">
        ...
        <div className="flex-1 overflow-y-auto px-5 sm:px-6 py-5">
          ...
          <div className="border-t pt-3 sm:pt-5 -mx-4 sm:mx-0 px-4 sm:px-0">
            ...
            {isLoading ? (
              <div className="text-center py-8 text-gray-500">
                <div className="animate-spin rounded-full h-10 w-10 sm:h-8 sm:w-8 border-b-2 border-primary mx-auto mb-3"></div>
          ...
          <div className={`border-t pt-4 space-y-3 transition-all duration-300 -mx-4 sm:mx-0 px-4 sm:px-0 mb-4 ${
            hasValueChanged ? 'bg-gradient-to-br from-primary/5 to-indigo-50 py-4 rounded-xl border-2 border-primary/20 shadow-sm' : ''
          }`}>
            {/* Total Amount */}
            <div className="flex justify-between items-start gap-3">
              ...
              <span className={`text-2xl sm:text-3xl font-bold transition-colors duration-300 ${
                hasValueChanged ? 'text-primary' : 'text-gray-900'
              }`}>
            ...
            <div className="flex justify-between items-start gap-3 pb-3 border-b border-gray-200">
              ...
              <span className={`text-xl sm:text-2xl font-bold transition-colors duration-300 ${
                hasValueChanged ? 'text-primary' : 'text-green-600'
              }`}>
            ...
            {hasValueChanged && (
              <div className="bg-white rounded-lg p-3 border border-primary/20">
                <div className="flex items-center justify-between gap-3">
                  <span className="text-sm font-bold text-primary/90">Diferença:</span>
        ...
        <DialogFooter className="px-5 sm:px-6 py-4 sm:py-5 border-t bg-white flex-shrink-0 flex-col-reverse sm:flex-row gap-3 rounded-b-2xl shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
          ...
          {isEditable && (
            <Button
              ...
              className="w-full sm:w-auto min-h-[52px] sm:min-h-[44px] touch-manipulation text-base font-bold bg-gradient-to-r from-primary to-indigo-600 hover:from-primary/90 hover:to-accent/90 disabled:from-gray-300 disabled:to-gray-300 shadow-md rounded-xl"
