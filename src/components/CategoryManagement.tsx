  ...
  return (
    <div className="space-y-6">
      <Button 
        ...
        className="w-full bg-gradient-to-r from-primary/50 to-blue-600 hover:from-primary hover:to-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 h-12"
      >
