  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden p-0 gap-0">
        <DialogHeader className="px-6 pt-6 pb-4 bg-gradient-to-r from-primary to-indigo-600">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-6 py-4 overflow-y-auto max-h-[calc(90vh-200px)]">
              ...
              <div className="space-y-3">
                {items.length === 0 ? (
                  ...
                  items.map((item) => (
                    <div
                      key={item.id}
                      className="flex items-center gap-3 p-4 bg-gradient-to-r from-primary/5 to-indigo-50 rounded-xl border-2 border-primary/10 hover:border-primary/20 transition-all"
                    >
                      ...
                      <div className="flex items-center gap-2 bg-white rounded-lg p-1 shadow-sm">
                        <Button
                          ...
                          className="h-8 w-8 hover:bg-primary/10 hover:text-primary/90"
                        >
              ...
              <div className="grid grid-cols-2 gap-3 max-h-[240px] overflow-y-auto p-3 bg-gray-50 rounded-xl border-2 border-gray-200">
                {menuItems.map((menuItem) => (
                  <Button
                    ...
                    className="justify-start h-auto py-3 px-4 bg-white hover:bg-primary/5 hover:border-primary/30 border-2 transition-all"
                  >
            ...
            {/* Total */}
            <div className="bg-gradient-to-r from-primary to-indigo-600 rounded-xl p-5 shadow-lg">
