...
describe('E2E: Complete Waiter Payment Workflow', () => {
  ...
  describe('Happy Path: Create Order → Generate PIX → Payment → Commission', () => {
    it('should complete full workflow from order creation to commission calculation', async () => {
      ...
      const pixResponse = {
        qr_code: '00020126580014br.gov.bcb.pix0136123e4567-e89b-12d3-a456-426614174000520400005303986540565.005802BR5913Pontal Carapitangui6009SAO PAULO62070503***63041D3D',
        qr_code_base64: 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==',
        amount: 65.00,
        expires_at: new Date(Date.now() + 15 * 60 * 1000).toISOString(),
        pix_key: 'pix@pontalcarapitangui.com'
      };
