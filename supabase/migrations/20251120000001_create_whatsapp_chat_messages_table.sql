...
CREATE INDEX IF NOT EXISTS idx_chat_phone ON whatsapp_chat_messages(phone_number);
CREATE INDEX IF NOT EXISTS idx_chat_order ON whatsapp_chat_messages(order_id);
CREATE INDEX IF NOT EXISTS idx_chat_created_at ON whatsapp_chat_messages(created_at);
