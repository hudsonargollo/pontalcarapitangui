...
-- CREATE INDEX IF NOT EXISTS idx_whatsapp_alerts_is_resolved ON whatsapp_alerts(is_resolved);
...
DROP POLICY IF EXISTS "Allow service role to insert error logs" ON whatsapp_error_logs;
...
DROP POLICY IF EXISTS "Allow authenticated users to read alerts" ON whatsapp_alerts;
...
DROP POLICY IF EXISTS "Allow authenticated users to update alerts" ON whatsapp_alerts;
...
DROP POLICY IF EXISTS "Allow service role to insert alerts" ON whatsapp_alerts;
