...
CREATE TABLE IF NOT EXISTS customers (
    ...
    phone_number VARCHAR(20) UNIQUE NOT NULL, -- Unique key (format: +5511999999999)
    name VARCHAR(255),
...
BEGIN
    ...
    INSERT INTO customers (phone_number, name, first_order_date, last_order_date, total_orders, total_spent)
    VALUES (
        NEW.customer_phone,
        NEW.customer_name,
        NEW.created_at,
...
BEGIN
    SELECT json_build_object(
        ...
        'top_customers', (
            ...
            FROM (
                SELECT name, phone_number, total_orders, total_spent
                FROM customers
