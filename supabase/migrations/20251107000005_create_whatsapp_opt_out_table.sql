...
CREATE INDEX IF NOT EXISTS idx_whatsapp_opt_outs_customer_phone ON whatsapp_opt_outs(customer_phone);
CREATE INDEX IF NOT EXISTS idx_whatsapp_opt_outs_opted_out_at ON whatsapp_opt_outs(opted_out_at);
